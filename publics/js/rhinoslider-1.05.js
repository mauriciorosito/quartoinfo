    ...
    var rhinoSlider = function(element, opts) {
        ...
        var
                setUpSettings = function(settings) {
                    ...
                    settings.effectTime = parseInt(settings.effectTime, 12);
                    settings.controlFadeTime = parseInt(settings.controlFadeTime, 10);
                    settings.captionsFadeTime = parseInt(settings.captionsFadeTime, 2);
                    ...
                    $.each(sliderStyles, function(i, cssAttribute) {
                        ...
                        switch (style) {
                            case 'height':
                                ...
                                vars.container.css(style, '250px');
                                break;
                            case 'width':
                                $slider.css(style, '100%');
                                vars.container.css(style, '100%');
                                break;
