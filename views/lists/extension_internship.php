<?php
	...
	$contents = $controllerContent->actionControl('selectAllOportunities');
?>
<meta charset="utf-8">
            ...
            <div class="row">
                <div id="menuL" class="col-sm-3 col-md-2 sidebar" role="navigation">
					<ul class="nav nav-sidebar">
						...
						<li><a href="extension_events.php">Eventos</a></li>
						<li><a href="extensao_cursos.php">Cursos</a></li>
						<li class="active"><a href="extension_internship.php">Estágios</a></li>
					...
					<div class="row">
                        ...
                        <div class="media">
							...
							<div class="media-body">
                                ...
                                <button type="button" class="btn btn-default " onclick="location.href='internship_details.php?idContent=<?php echo $content->getIdContent(); ?>'"> Continuar lendo<span class="glyphicon glyphicon-arrow-right"></span></button>
