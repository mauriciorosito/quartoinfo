                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-col-md-4 col-md-offset-9">
                                                                ...
                                                                <div class="btn-group" style="margin-top:15px;">
                                                                    <button type="button" class="btn btn-default" onclick="location.href = '../../views/lists/login.php'">Login</button>
                                                                    <button type="button" class="btn btn-default" onclick="location.href = '../../views/forms/user.form.php?action=insert'">Cadastrar</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
