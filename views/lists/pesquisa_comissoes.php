                    ...
                    <div class="row">
                        <div id="menuL" class="col-sm-3 col-md-2 sidebar" role="navigation">
							<ul class="nav nav-sidebar">
								...
								<li class="active"><a href="pesquisa_comissoes.php" class="sld" >Comissões</a></li>
								
									<ul class="escondido"> 
								
										<li><a href="pesquisa_comissoes_CAGPPI.php">CAGPPI</a></li> 
									</ul>
						...
						<h3><b>Sobre as Comissões</b></h3> <br>						
							<p style="text-align: justify"> As atividades de pesquisa realizadas no IFRS-Câmpus Bento Gonçalves contam com o apoio e
							regulamentação de comissões formadas por professores e técnicos administrativos. </p>
						</div>
