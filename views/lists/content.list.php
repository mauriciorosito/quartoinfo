            ...
            <div class="container img-rounded BVerde">
                <div class="row standard-margin-10">
                    <div class="col-md-2 col-sm-12 col-xs-12">
                        <a href="../forms/content.form.php?action=insert&tipo=<?php if ($_REQUEST["tipo"] == "C") echo "conteudo";
        else echo "pagina"; ?>" class="btn btn-default">
                            <i class="glyphicon glyphicon-plus-sign"></i>
                            &nbsp; Inserir <?php if ($_REQUEST["tipo"] == "C") echo "Conteúdo";
        else echo "Página"; ?>
                        </a><br><br>
                        <span>Listar:</span>
                        <br>
