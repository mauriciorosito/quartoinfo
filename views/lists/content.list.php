        ...
        <div id="content">
            <div class="container img-rounded BVerde">
                <div class="row standard-margin-10">
					...
					<div class="row standard-margin-10"><br><br><br><br><br><br>
						<?php if(isset($_GET["msg"])){
							if($_REQUEST["tipo"] == "C") $tipo = "Conteúdo";
							Else $tipo = "Página";
							echo '<div class="alert alert-success" role="alert"> '.$tipo.' '.strtolower($_GET['msg']).' com <b>Sucesso!</b></div>';
						}?>
					</div>
                </div>
                        ...
                        if ($_REQUEST['pesquisa'] == "") {
                            foreach ($contents as $content) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo Formatter::getDateBrazilianFormat($content->getPostDate()); ?></td>
                                    <td><?php echo Formatter::getDateBrazilianFormat($content->getExpirationDate()); ?></td>
                                    <td>
                                        <?php
                            ...
                            <center>
                                <div class="btn-group">
                                    <a href="../forms/content.form.php?action=update&tipo=C&idContent=<?php echo $content->getIdContent(); ?> " class="btn btn-default">
                                        <span class="glyphicon glyphicon-edit"></span>
                                    </a> 
                                    <a href="../forms/content.form.php?action=delete&tipo=C&idContent=<?php echo $content->getIdContent(); ?>" class="btn btn-default">
                        ...
                        if (isset($resultados)) {
                            foreach ($resultados as $resultado) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo Formatter::getDateBrazilianFormat($resultado["postDate"]); ?></td>
                                    <td><?php echo Formatter::getDateBrazilianFormat($resultado["expirationDate"]); ?></td>
                                    <td>
                                        <?php
                                        if($resultado["type"] == "E"){
                                            echo "Evento";
