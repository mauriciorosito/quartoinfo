    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav">
                <li><a href="../lists/user.list.php"><i class="glyphicon glyphicon-user"></i> &nbsp; Usuários</a></li>
                <li><a href="../lists/content.list.php"><i class="glyphicon glyphicon-list-alt"></i> &nbsp; Conteúdos</a></li>
